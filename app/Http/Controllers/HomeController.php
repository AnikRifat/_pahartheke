...
class HomeController extends Controller
{
    ...
    public function variant_price(Request $request)
    {
        ...
        if ($product->tax_type == 'percent') {
         ...
         $qty = $request->type == "attr" ? $min_qty : $request->quantity;

        return array('price' => single_price($price * $qty), 'quantity' =>  $quantity, 'digital' => $product->digital,'min_qty'=> $min_qty ,'sq'=> $qty);
    }
    ...
    public function home_infinite_scroll(Request $request)
    {
        return new HomeInfiniteCollection(Product::where('published', 1)->latest()->paginate(10));
    }
