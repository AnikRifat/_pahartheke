...
Route::post('/update-discount-cart-pos', 'PosController@updateDiscount')->name('pos.updateDiscount');
Route::post('/update-discount-type-cart-pos', 'PosController@updateDiscountType')->name('pos.updateDiscountType');
