        ...
        <form class="form form-horizontal mar-top" action="{{ route('products.store') }}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="unit"
                                placeholder="{{ translate('Unit (Ex: 1 pieces,1/2 Kg,250gram,1kg per bag)') }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select name="choice_attributes[]" id="choice_attributes"
                                ...
                                data-live-search="true" multiple data-placeholder="{{ translate('Choose Attributes') }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row" id="quantity">
                        <label class="col-md-3 col-from-label">{{ translate('Show stock number?') }}</label>
                        <div class="col-md-6">
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="checkbox" name="show_stock" checked>
                                <span></span>
                            </label>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        function add_more_customer_choice_option(i, name) {
            $('#customer_choice_options').append(
                ...
                i + '[]" placeholder="{{ translate('Enter choice values') }}" data-on-change="update_sku"></div></div>'
                );
