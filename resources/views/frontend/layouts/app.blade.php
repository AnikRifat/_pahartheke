...
})(window,document,'script','dataLayer','GTM-M4Z5HL4');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M4Z5HL4"
...
@yield('fbq')
    <script>
        ...
        function updateNavCart(e = null){
            ...
            $.post('{{ route('cart.nav_cart') }}', {_token: AIZ.data.csrf, quantity: quantity, key: key }, function(data){
                $('#sidebar-cart').html(data.view);
        ...
        $('.btn-attr').change(function() {
            getVariantPrice('attr');
        });

        $('.btn-m').click(function() {
            getVariantPrice('minus');
        });
        $('.btn-p').click(function() {
            getVariantPrice('plus');
        });
        function getVariantPrice(types){
            if($('#option-choice-form input[name=quantity]').val() > 0 && checkAddToCartValidity()){
                var formData = $('#option-choice-form').serializeArray();
        formData.push({ name: 'type', value: types });
console.log(formData);
                $.ajax({
                   ...
                   success: function(data){
                    console.log(data);
                       ...
                       $('.input-number').val(data.sq);
                       $('.minqt').html(data.min_qty);
        ...
        function addToCart(e = null){
            ...
            if(typeof id != 'undefined'){
                // console.log(id);
                $(e).append('<span class="spinner-border spinner-border-sm ml-1"></span>');
